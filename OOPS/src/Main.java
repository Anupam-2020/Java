import Encapsulation_3.User_Enc;
import This.demo_1.Student;
...
//        System.out.println(x);
        ...
        // ---------------------------------this demo.------------------------------
        Student stud = new Student("Anupam", 27);
        System.out.println(stud);

        // -------------------------------Encapsulation------------------------------
        User_Enc userEnc = new User_Enc();
        userEnc.username = "Anupam"; // Only username is public.
        System.out.println(userEnc.username);
    }
}
